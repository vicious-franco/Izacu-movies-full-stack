...
const WatchPage = () => {
  return (
    <section className="bg-black h-full w-full overflow-y-scroll scroll-style flex ">
      <div className=" flex flex-col md:flex-row gap-4 w-full">
          ...
          <div className="w-full">
            ...
            <div className="flex">
              <div className=" my-10 flex gap-10">
                <div className="md:max-h-70 max-h-50  min-w-30 md:min-w-40 max-w-50">
                  <img
                    className="w-full h-full object-cover"
                    src={avatar}
                    alt=""
                ...
                <div className="text-indigo-100 space-y-3  ">
                  ...
                  <p className="text-gray-500 text-sm font-light max-w-100">
        ...
        <div className="shrink-0 text-indigo-100 border border-white/10  h-full ">
          <h1 className="font-semibold block text-center  my-7 text-lg uppercase   ">
            you may also like this
          </h1>
          <div className="flex flex-row flex-wrap md:flex-nowrap justify-center gap-8 md:flex-col   w-full  px-4 md:gap-2 md:h-full overflow-auto scroll-style ">
